...
const UpdateTaskForm = ({
  ...
  const onSubmit = async (e) => {
    ...
    const response = await handleUpdate(payload, task.id);
  ...
  return (
    ...
    >
      ...
      <form onSubmit={onSubmit} className="flex flex-col gap-4 py-6">
        ...
        <div>
          <label htmlFor="title" className="block mb-2 text-[1.2rem]">
            Title
          </label>
          <input
            id="title"
        ...
        <div>
          <label htmlFor="description" className="block mb-2 text-[1.2rem]">
            Description
          </label>
          <textarea
            id="description"
        ...
        <div>
          <label htmlFor="status" className="block mb-2 text-[1.2rem]">
            Status
          </label>
          <select
            id="status"
        ...
        <div>
          <label htmlFor="priority" className="block mb-2 text-[1.2rem]">
            Priority
          </label>
          <select
            id="priority"
        ...
        <div>
          <label htmlFor="due_date" className="block mb-2 text-[1.2rem]">
            Due Date
          </label>
          <input
            id="due_date"
