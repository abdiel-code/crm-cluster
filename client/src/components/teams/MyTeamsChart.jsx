...
const MyTeamsChart = ({ team, handleDeleteTeamModal, handleFetchMembers }) => {
  ...
  return (
    <div className="w-full h-full flex flex-col">
      <div className="w-full h-full flex items-center justify-around rounded-[10px] bg-white shadow-[4px_4px_4px_rgba(0,0,0,0.20)] py-2">
        <div className=" w-[4px] h-[100%] bg-[#577399] rounded-2xl">
        </div>
        ...
        <button
          ...
          onClick={() => handleDeleteTeamModal(id)}
        >

          <div className="w-[80%] h-1 bg-white rounded-full">
          </div>
        </button>
        <button
          type="button"
